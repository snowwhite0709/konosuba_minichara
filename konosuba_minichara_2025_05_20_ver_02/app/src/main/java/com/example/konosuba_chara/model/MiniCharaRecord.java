...
public class MiniCharaRecord {
    ...
    public MiniCharaRecord(int bigNumber, String dateTime, Map<String, Integer> charaCounts, Map<String, Double> charaRates, Map<String, Integer> categoryCounts, Map<String, Double> categoryRates) {
